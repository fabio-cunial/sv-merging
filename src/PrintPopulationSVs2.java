...
public class PrintPopulationSVs2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String INPUT_FILE_TRUVARI = args[8];
        final String INPUT_FILE_JASMINE = args[9];
        final String INPUT_FILE_SVIMMER = args[10];
        final String INPUT_FILE_JOINT = args[11];
        ...
        drawVCF(3,INPUT_FILE_JOINT,CHR,ONLY_PASS,FROM_POS,TO_POS,0,0);
        drawVCF(4,INPUT_FILE_BCFTOOLS_MERGE,CHR,ONLY_PASS,FROM_POS,TO_POS,0,0);
        ...
        System.err.println("Printing: joint");
        drawVCF(-1,INPUT_FILE_JOINT,CHR,ONLY_PASS,FROM_POS,TO_POS,y,y+maxRows[3]-1);
        y+=maxRows[3];
        for (x=0; x<N_COLUMNS; x++) image.setRGB(x,y,COLOR_BACKGROUND_LINE);
        y++;
